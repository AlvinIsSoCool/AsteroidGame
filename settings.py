...
""" Difficulty Options. Change the following values carefully.
	...
	- SPEED_MULTIPLIER_CAP: Caps speed multiplication to the defined value. Keeps difficulty sustainable.
							Does not affect enemy spawn delay calculations. (Default: 4.0 or 400% speed)
	- BASE_DRIFT: The base drift that the elements will take. (Default: 1.0 or 100% drift)
	- DRIFT_MULTIPLIER_PROGRESS: The percentage per minute the drift multiplies by. (Default: 0.05 or 5% per minute)
...
BASE_DRIFT=1.0
DRIFT_MULTIPLIER_PROGRESS=0.05
